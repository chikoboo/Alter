...
- 🎤 **リアルタイム文字起こし** — Moonshine Voice でオンデバイス高速・高精度STT
...
Python Backend (FastAPI + WebSocket)
  ...
  ├── STT:   Moonshine Voice (オンデバイスASR + 内蔵VAD)
...
│   │   └── devices.py           # デバイス列挙
│   ├── transcription/
│   │   ├── engine.py            # Moonshine Voice統合
│   │   └── vad.py               # VAD (レガシー / Moonshine内蔵VADを使用)
│   ├── ai/
...
python main.py [OPTIONS]
  ...
  --language LANG  文字起こし言語（デフォルト: ja）
```
